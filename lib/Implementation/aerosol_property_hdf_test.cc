...
BOOST_AUTO_TEST_CASE(basic)
{
  ...
  BOOST_CHECK_CLOSE(a.extinction_coefficient(13000).value(), 0.9321898305, 
		    1e-8);
  BOOST_CHECK_CLOSE(a.scattering_coefficient(13000).value(), 0.877556390083, 
		    1e-8);
  ...
  BOOST_CHECK_MATRIX_CLOSE(a.phase_function_moment(13000).value()(Range(0,1), 
								  Range::all()),
			   pf_expect);
}
