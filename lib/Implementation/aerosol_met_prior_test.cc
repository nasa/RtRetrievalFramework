...
BOOST_AUTO_TEST_CASE(basic)
{
  ...
  cov =
    ...
    0, 0.16, 0,
    0, 0, 1e-4;
  AerosolMetPrior ma(*mclimate, aprop, DoubleWithUnit(36.278789520264, "deg"),
...
BOOST_AUTO_TEST_CASE(dejian_example)
{
  ...
  cov =
    ...
    0, 0.16, 0,
    0, 0, 1e-4;
  AerosolMetPrior ma1(*mclimate, aprop, DoubleWithUnit(17.000, "deg"),
		   DoubleWithUnit(8, "deg"), p, rh_dummy, cov);
  AerosolMetPrior ma2(*mclimate, aprop, DoubleWithUnit(36.6040, "deg"),
		   DoubleWithUnit(-97.4860, "deg"), p, rh_dummy, cov);
  AerosolMetPrior ma3(*mclimate, aprop, DoubleWithUnit(39.9060, "deg"),
		   DoubleWithUnit(116.4060, "deg"), p, rh_dummy, cov);
  AerosolMetPrior ma4(*mclimate, aprop, DoubleWithUnit(-7.9165, "deg"),
