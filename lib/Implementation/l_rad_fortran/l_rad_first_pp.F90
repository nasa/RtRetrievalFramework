...
!  Get the exact first-order calculation
      ...
      call L_sscorr_pp &
         (nlay,nstokes, & !I
          ...
          emu,emu0, & !
          Zmat,L_Zmat, & !I
          alla_i,allb_i,L_alla_i,L_allb_i, & !I
          alla,allb,L_alla,L_allb, & !I
          R1,L_R1,Ls_R1) !O
...
!  Finish
      ...
      return
      end subroutine L_rad_first_pp

end module l_rad_first_pp_m
