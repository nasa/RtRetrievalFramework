...
// Gcc 4.2 on Mac doesn't like passing ArrayAd<double, 2>() as default
// argument to stokes_single_wn (although this is legal C++). Use
// dummy variable as a workaround. 
ArrayAd<double, 2> RadiativeTransferSingleWn::dummy;
