...
parser = argparse.ArgumentParser(description='Create LIDORT C++ interfaces')
parser.add_argument('lidort_path', help='Path to LIDORT source code')
...
SLEAVE_DEF_FILENAMES = (
    "sleave_sup_inputs_def.F90",
    )

for sleave_def_fn in SLEAVE_DEF_FILENAMES:
    DEF_FILENAMES.append(os.path.join(SLEAVE_MAIN_DIR, sleave_def_fn))
...
##
# Name of some templates used from the templates directory
...
F_INTERFACE_TYPES_FILENAME = os.path.join(args.output_path, "%s.F90" % INTERFACE_TYPES_MODULE_NAME)
F_INTERFACE_TYPES_IO_FILENAME = os.path.join(args.output_path, "%s_io.F90" % INTERFACE_TYPES_MODULE_NAME)
H_INTERFACE_TYPES_FILENAME = os.path.join(args.output_path, "%s.h" % INTERFACE_TYPES_MODULE_NAME)
I_INTERFACE_TYPES_FILENAME = os.path.join(args.output_path, "%s.i" % INTERFACE_TYPES_MODULE_NAME)
TST_INTERFACE_TYPES_FILENAME = os.path.join(args.output_path, "%s_test.cc" % INTERFACE_TYPES_MODULE_NAME)
...
F_INTERFACE_MASTERS_IO_FILENAME = os.path.join(args.output_path, "%s_io.F90" % INTERFACE_MASTERS_NAME)
...
###
# Create C type tests
write_cpp_type_tests(TST_INTERFACE_TYPES_FILENAME, def_type_wrappers, pars_wrapper, suite_name=INTERFACE_TYPES_MODULE_NAME, addl_includes=[os.path.basename(H_INTERFACE_TYPES_FILENAME)])
...
write_cpp_master_classes(H_INTERFACE_MASTERS_FILENAME, I_INTERFACE_MASTERS_FILENAME, 
                         masters_list, I_INTERFACE_TYPES_FILENAME,
                         h_template_fn="lidort_masters.h",
                         addl_includes=[os.path.basename(H_INTERFACE_TYPES_FILENAME)])
