...
SUBROUTINE THERMAL_SETUP_PLUS                                    &
      ( DO_UPWELLING, DO_DNWELLING, DO_THERMAL_TRANSONLY,        & !input
        ...
        THREAD, LAYERMASK_UP, LAYERMASK_DN,                      & !input
...
!  Thermal Blackbody inputs
      ...
      REAL(fpk), intent(in)  :: BB_INPUT (0:MAXLAYERS,MAXTHREADS)
...
!  ---------------
      ...
      INTEGER   :: N, S, T, UT, UM, Q, NPARS, NT
...
!  initial set of coefficients
      ...
      t = thread
      DO n = 1, nlayers
       thermcoeffs(n,1) = bb_input(n-1,t)
       help(n) = (bb_input(n,t)-bb_input(n-1,t)) / deltau_vert(n)
      END DO
...
! ---------------
      ...
      INTEGER   :: AA, AA1, I, I1, S, N, UT, NT, Q, NSTREAMS_2
