...
!  single scatter results
      ...
      REAL(fpk), intent(inout) :: PROFILEWF_SS &
...
!  other help variables
      ...
      REAL(fpk)  :: L_FINAL_SOURCE, L_SS_LAYERSOURCE
      REAL(fpk)  :: L_SSCORRECTION, L_TR_CUMSOURCE
      REAL(fpk)  :: VAR_TMS(MAX_ATMOSWFS), LEGPOLY, L_PHASMOM
