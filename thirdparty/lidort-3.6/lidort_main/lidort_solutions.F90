...
!mick fix 6/29/11 - changed 4 outputs from "out" to "inout"
...
!  ---------------
      ...
      REAL(fpk)    :: RHO_P, RHO_M, SECMUI, ULP
...
!  module,  dimensions and numbers
      ...
      USE LIDORT_pars, only : MAXSTREAMS, MAX_USER_STREAMS, MAX_USER_LEVELS, MAXLAYERS, MAX_PARTLAYERS, &
                              ONE
...
!  ---------------
      ...
      REAL(fpk)    :: UDEL, SM
      REAL(fpk)    :: ZDEL, ZUDEL, THETA_1, THETA_2
      REAL(fpk)    :: UX_UP, UX_DN, ZX_UP, ZX_DN
      REAL(fpk)    :: THETA_DN, THETA_UP
...
!  module,  dimensions and numbers
      ...
      USE LIDORT_pars, only : MAXSTREAMS, MAXSTREAMS_2, MAXMOMENTS, MAXLAYERS, MAXBEAMS, &
                              ZERO, ONE, PI4
...
!  ===============
      ...
      REAL(fpk)    :: RHO_M, RHO_P, F1
      REAL(fpk)    :: CONST, SECBAR, WDEL, ZDEL, ZWDEL
