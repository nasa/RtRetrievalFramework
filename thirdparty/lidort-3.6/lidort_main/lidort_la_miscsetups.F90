...
!  module, dimensions and numbers
      ...
      USE LIDORT_pars, only : MAXMOMENTS_INPUT, MAXLAYERS, MAXTHREADS, MAXMOMENTS,  &
...
!  Linearized Input optical depths before scaling (Threaded input)

      REAL(fpk), intent(in)  :: L_OMEGA_TOTAL_INPUT ( MAX_ATMOSWFS, MAXLAYERS, MAXTHREADS )
      REAL(fpk), intent(in)  :: L_DELTAU_VERT_INPUT ( MAX_ATMOSWFS, MAXLAYERS, MAXTHREADS )
