...
------------------------------------------------------------
   ...
   static_eof_file = oco_base_config_dir .. "/../input/l2_gosat_eof.h5",
      ...
      instrument = {
         ...
         instrument_correction = {
	       ...
	       hdf_group = "Instrument/EmpiricalOrthogonalFunction/H_gain",
            ...
            eof_h_gain_3 = {
	       hdf_group = "Instrument/EmpiricalOrthogonalFunction/H_gain",
               apriori = ConfigCommon.hdf_apriori_i_j("Instrument/EmpiricalOrthogonalFunction", 3 - 1),
               covariance = ConfigCommon.hdf_covariance_i_j("Instrument/EmpiricalOrthogonalFunction", 3 - 1),
               order = 3,
               creator = ConfigCommon.empirical_orthogonal_function,
               retrieve_bands = { true, true, true },
            },
