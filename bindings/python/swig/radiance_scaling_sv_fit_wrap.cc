...
#include "radiance_scaling_sv_fit_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_RadianceScalingSvFit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__RadianceScalingSvFit_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_RadianceScalingSvFit", (PyCFunction)_wrap_delete_RadianceScalingSvFit, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::RadianceScalingSvFit::~RadianceScalingSvFit()\n"
		"\n"
		""},
	 { (char *)"RadianceScalingSvFit__v_radiance_scaling_coeff_uncertainty", (PyCFunction)_wrap_RadianceScalingSvFit__v_radiance_scaling_coeff_uncertainty, METH_O, (char *)"\n"
		"\n"
