...
#include "nonuniform_spectrum_sampling_wrap.h"
...
SWIGINTERN PyObject *_wrap_NonuniformSpectrumSampling_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"NonuniformSpectrumSampling_spectral_domain",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NonuniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"NonuniformSpectrumSampling_spectral_domain", _wrap_NonuniformSpectrumSampling_spectral_domain, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"delete_NonuniformSpectrumSampling", (PyCFunction)_wrap_delete_NonuniformSpectrumSampling, METH_O, (char *)"\n"
		"\n"
