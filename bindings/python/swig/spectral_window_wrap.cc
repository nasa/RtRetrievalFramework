...
#include "spectral_window_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_SpectralWindow(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralWindow_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SpectralWindow_apply(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SpectralWindow_apply",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralWindow_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SpectralWindow_grid_indexes(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SpectralWindow_grid_indexes",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralWindow_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_SpectralWindow", (PyCFunction)_wrap_delete_SpectralWindow, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::SpectralWindow::~SpectralWindow()\n"
		"\n"
		""},
	 { (char *)"SpectralWindow___str__", (PyCFunction)_wrap_SpectralWindow___str__, METH_O, NULL},
	 ...
	 { (char *)"SpectralWindow_grid_indexes", _wrap_SpectralWindow_grid_indexes, METH_VARARGS, (char *)"\n"
		...
		"the window. \n"
		""},
	 { (char *)"SpectralWindow__v_number_spectrometer", (PyCFunction)_wrap_SpectralWindow__v_number_spectrometer, METH_O, (char *)"\n"
		"\n"
		"virtual int FullPhysics::SpectralWindow::number_spectrometer() const =0\n"
		"Number of spectrometers. \n"
		""},
	 { (char *)"SpectralWindow__v_spectral_bound", (PyCFunction)_wrap_SpectralWindow__v_spectral_bound, METH_O, (char *)"\n"
		"\n"
