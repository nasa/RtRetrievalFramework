...
#include "uniform_spectrum_sampling_wrap.h"
...
SWIGINTERN PyObject *_wrap_UniformSpectrumSampling_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"UniformSpectrumSampling_spectral_domain",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UniformSpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"UniformSpectrumSampling_spectral_domain", _wrap_UniformSpectrumSampling_spectral_domain, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"delete_UniformSpectrumSampling", (PyCFunction)_wrap_delete_UniformSpectrumSampling, METH_O, (char *)"\n"
		"\n"
