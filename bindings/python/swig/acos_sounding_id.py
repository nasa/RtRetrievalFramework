...
class AcosSoundingId(full_physics_swig.hdf_sounding_id.HdfSoundingId):
    ...
    def __init__(self, *args): 
        ...
        """
        _acos_sounding_id.AcosSoundingId_swiginit(self,_acos_sounding_id.new_AcosSoundingId(*args))
    def create(*args):
        """
