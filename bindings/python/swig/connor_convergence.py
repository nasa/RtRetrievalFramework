...
if version_info >= (3,0,0):
    new_instancemethod = lambda func, inst, cls: _connor_convergence.SWIG_PyInstanceMethod_New(func)
else:
...
class ConnorConvergence(full_physics_swig.convergence_check.ConvergenceCheck):
    ...
    def __init__(self, *args): 
        ...
        """
        _connor_convergence.ConnorConvergence_swiginit(self,_connor_convergence.new_ConnorConvergence(*args))
