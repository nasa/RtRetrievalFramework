...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_oco_sim_met_ecmwf')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_oco_sim_met_ecmwf')
...
class OcoSimMetEcmwf(full_physics_swig.meteorology.Meteorology):
    ...
    def __init__(self, Fname, Hdf_sounding_id):
        ...
        """
        _oco_sim_met_ecmwf.OcoSimMetEcmwf_swiginit(self, _oco_sim_met_ecmwf.new_OcoSimMetEcmwf(Fname, Hdf_sounding_id))
