...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _solar_absorption_oco_file.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_solar_absorption_oco_file')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_solar_absorption_oco_file')
...
class SolarAbsorptionOcoFile(full_physics_swig.solar_absorption_spectrum.SolarAbsorptionSpectrum):
    ...
    def __init__(self, Hdf_static_input, Hdf_group, Fraction_solar_diameter):
        ...
        """
        _solar_absorption_oco_file.SolarAbsorptionOcoFile_swiginit(self, _solar_absorption_oco_file.new_SolarAbsorptionOcoFile(Hdf_static_input, Hdf_group, Fraction_solar_diameter))
...
SolarAbsorptionOcoFile._v_number_line = new_instancemethod(_solar_absorption_oco_file.SolarAbsorptionOcoFile__v_number_line, None, SolarAbsorptionOcoFile)
SolarAbsorptionOcoFile._v_fraction_solar_diameter = new_instancemethod(_solar_absorption_oco_file.SolarAbsorptionOcoFile__v_fraction_solar_diameter, None, SolarAbsorptionOcoFile)
