...
#include "radiance_scaling_linear_fit_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_RadianceScalingLinearFit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__RadianceScalingLinearFit_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_RadianceScalingLinearFit", (PyCFunction)_wrap_delete_RadianceScalingLinearFit, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::RadianceScalingLinearFit::~RadianceScalingLinearFit()\n"
		"\n"
		""},
	 { (char *)"RadianceScalingLinearFit__v_radiance_scaling_coeff_uncertainty", (PyCFunction)_wrap_RadianceScalingLinearFit__v_radiance_scaling_coeff_uncertainty, METH_O, (char *)"\n"
		"\n"
