...
#include "nlls_problem_state_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_NLLSProblemState(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NLLSProblemState_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_NLLSProblemState_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"NLLSProblemState_set",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NLLSProblemState_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
  ...
  }
  {
    ...
    res2 = SWIG_ConvertPtrAndOwn(swig_obj[1], (void**)(&ptr), SWIGTYPE_p_FullPhysics__NLLSProblemState,  0 , &newmem);
    if (SWIG_IsOK(res2)) {
      arg2 = ptr;
    } else {
      res2 = SWIG_ConvertPtrAndOwn(swig_obj[1], &argp2, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NLLSProblemState_t,  0 , &newmem);
      if (!SWIG_IsOK(res2)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_NLLSProblemState", (PyCFunction)_wrap_delete_NLLSProblemState, METH_O, (char *)"\n"
		"\n"
