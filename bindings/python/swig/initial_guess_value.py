...
class InitialGuessValue(full_physics_swig.composite_initial_guess.InitialGuessBuilder):
    ...
    def apriori_subset(self, *args):
        ...
        """
        return _initial_guess_value.InitialGuessValue_apriori_subset(self, *args)

    def apriori_covariance_subset(self, *args):
        """
        void InitialGuessValue::apriori_covariance_subset(const blitz::Array< bool, 1 > &Flag, const blitz::Array< double, 2 >
        &V)
        Subset a value to include only those elements where Flag is true. 
        """
        return _initial_guess_value.InitialGuessValue_apriori_covariance_subset(self, *args)
