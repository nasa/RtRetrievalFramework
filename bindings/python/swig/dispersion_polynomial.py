...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _dispersion_polynomial.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_dispersion_polynomial')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_dispersion_polynomial')
...
class DispersionPolynomial(full_physics_swig.dispersion.SubStateVectorArrayDispersion):
    ...
    def __init__(self, *args):
        ...
        Lua 
        """
        _dispersion_polynomial.DispersionPolynomial_swiginit(self, _dispersion_polynomial.new_DispersionPolynomial(*args))
...
DispersionPolynomial._v_pixel_grid = new_instancemethod(_dispersion_polynomial.DispersionPolynomial__v_pixel_grid, None, DispersionPolynomial)
