...
#include "solar_absorption_table_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_SolarAbsorptionTable(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_SolarAbsorptionTable",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
...
SWIGINTERN PyObject *_wrap_delete_SolarAbsorptionTable(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarAbsorptionTable_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *SolarAbsorptionTable_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_SolarAbsorptionTable", _wrap_new_SolarAbsorptionTable, METH_VARARGS, (char *)"\n"
		"\n"
		"SolarAbsorptionTable::SolarAbsorptionTable(const HdfFile &Hdf_static_input, const std::string &Hdf_group)\n"
		"Read the given file for the solar absorption spectrum. \n"
		""},
	 { (char *)"delete_SolarAbsorptionTable", (PyCFunction)_wrap_delete_SolarAbsorptionTable, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"SolarAbsorptionTable_swiginit", SolarAbsorptionTable_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
