...
SWIGINTERN PyObject *_wrap_GroundBrdfVeg_weight_parameters(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  FullPhysics::GroundBrdfVeg *arg1 = (FullPhysics::GroundBrdfVeg *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args,"GroundBrdfVeg_weight_parameters",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__GroundBrdfVeg_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "GroundBrdfVeg_weight_parameters" "', argument " "1"" of type '" "FullPhysics::GroundBrdfVeg const *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const FullPhysics::GroundBrdfVeg > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const FullPhysics::GroundBrdfVeg > * >(argp1);
  ...
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "GroundBrdfVeg_weight_parameters" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    try {
      result = ((FullPhysics::GroundBrdfVeg const *)arg1)->weight_parameters(arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"GroundBrdfVeg_weight", _wrap_GroundBrdfVeg_weight, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"GroundBrdfVeg_weight_parameters", _wrap_GroundBrdfVeg_weight_parameters, METH_VARARGS, (char *)"\n"
		"\n"
