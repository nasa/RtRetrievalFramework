...
#include "solar_absorption_spectrum_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_SolarAbsorptionSpectrum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarAbsorptionSpectrum_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SolarAbsorptionSpectrum_solar_absorption_spectrum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SolarAbsorptionSpectrum_solar_absorption_spectrum",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarAbsorptionSpectrum_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_SolarAbsorptionSpectrum", (PyCFunction)_wrap_delete_SolarAbsorptionSpectrum, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::SolarAbsorptionSpectrum::~SolarAbsorptionSpectrum()\n"
		"\n"
		""},
	 { (char *)"SolarAbsorptionSpectrum___str__", (PyCFunction)_wrap_SolarAbsorptionSpectrum___str__, METH_O, NULL},
