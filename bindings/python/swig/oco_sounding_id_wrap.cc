...
#include "oco_sounding_id_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_OcoSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_OcoSoundingId",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
...
SWIGINTERN PyObject *_wrap_delete_OcoSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__OcoSoundingId_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *OcoSoundingId_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_OcoSoundingId", _wrap_new_OcoSoundingId, METH_VARARGS, (char *)"\n"
		"\n"
		"OcoSoundingId::OcoSoundingId(const HdfFile &File, const std::string &Sounding_id)\n"
		...
		"\n"
		"The sounding ID should be in the format: 200907261717015 - Where the\n"
		"ending 5 is the sounding number \n"
		""},
	 { (char *)"delete_OcoSoundingId", (PyCFunction)_wrap_delete_OcoSoundingId, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"OcoSoundingId_swiginit", OcoSoundingId_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
