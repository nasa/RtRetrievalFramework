...
SWIGINTERN PyObject *_wrap_delete_NoiseModel(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_NoiseModel_uncertainty(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"NoiseModel_uncertainty",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__NoiseModel_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_NoiseModel", (PyCFunction)_wrap_delete_NoiseModel, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"NoiseModel_uncertainty", _wrap_NoiseModel_uncertainty, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"NoiseModel___str__", (PyCFunction)_wrap_NoiseModel___str__, METH_O, NULL},
