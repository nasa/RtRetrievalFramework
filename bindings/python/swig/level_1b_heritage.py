...
if version_info >= (3,0,0):
    new_instancemethod = lambda func, inst, cls: _level_1b_heritage.SWIG_PyInstanceMethod_New(func)
else:
...
class Level1bHeritage(full_physics_swig.level_1b.Level1b):
    ...
    def __init__(self, *args): 
        ...
        """
        _level_1b_heritage.Level1bHeritage_swiginit(self,_level_1b_heritage.new_Level1bHeritage(*args))
