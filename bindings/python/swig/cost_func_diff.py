...
class CostFuncDiff(full_physics_swig.cost_func.CostFunc):
    ...
    def gradient_x(self, *args):
        ...
        The gradient of the cost function 
        """
        return _cost_func_diff.CostFuncDiff_gradient_x(self, *args)

    def cost_gradient(self, *args):
        """
        ...
        """
        return _cost_func_diff.CostFuncDiff_cost_gradient(self, *args)

    def cost_gradient_x(self, *args):
        """
        ...
        g:  The gradient vector with size gradient_size() 
        """
        return _cost_func_diff.CostFuncDiff_cost_gradient_x(self, *args)
