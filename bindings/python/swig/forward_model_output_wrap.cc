...
#include "forward_model_output_wrap.h"
...
SWIGINTERN PyObject *_wrap_ForwardModelOutput_register_output(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ForwardModelOutput_register_output",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ForwardModelOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"ForwardModelOutput_register_output", _wrap_ForwardModelOutput_register_output, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"delete_ForwardModelOutput", (PyCFunction)_wrap_delete_ForwardModelOutput, METH_O, (char *)"\n"
		"\n"
