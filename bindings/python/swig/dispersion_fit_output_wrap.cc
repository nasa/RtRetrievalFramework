...
#include "dispersion_fit_output_wrap.h"
...
SWIGINTERN PyObject *_wrap_DispersionFitOutput_register_output(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"DispersionFitOutput_register_output",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__DispersionFitOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_DispersionFitOutput_register_output_apriori(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"DispersionFitOutput_register_output_apriori",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__DispersionFitOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"DispersionFitOutput_register_output_apriori", _wrap_DispersionFitOutput_register_output_apriori, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"delete_DispersionFitOutput", (PyCFunction)_wrap_delete_DispersionFitOutput, METH_O, (char *)"\n"
		"\n"
