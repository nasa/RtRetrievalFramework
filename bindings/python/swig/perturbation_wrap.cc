...
SWIGINTERN PyObject *_wrap_delete_Perturbation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Perturbation_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_Perturbation", (PyCFunction)_wrap_delete_Perturbation, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::Perturbation::~Perturbation()\n"
		"\n"
		""},
	 { (char *)"Perturbation___str__", (PyCFunction)_wrap_Perturbation___str__, METH_O, NULL},
	 { (char *)"Perturbation__v_perturbation", (PyCFunction)_wrap_Perturbation__v_perturbation, METH_O, (char *)"\n"
		"\n"
