...
class ConnorSolver(ObservableConnor):
    ...
    def save_test_data(self, *args):
        ...
        """
        return _connor_solver.ConnorSolver_save_test_data(self, *args)

    def test_do_inversion(self, *args):
        """
        ...
        """
        return _connor_solver.ConnorSolver_test_do_inversion(self, *args)
    ...
    def solve(self, *args):
        ...
        """
        return _connor_solver.ConnorSolver_solve(self, *args)
...
class ConnorSolverState(full_physics_swig.generic_object.GenericObject):
    ...
    def __init__(self, *args): 
        ...
        """
        _connor_solver.ConnorSolverState_swiginit(self,_connor_solver.new_ConnorSolverState(*args))
    def _v_x_i(self):
        """
...
class ObserverConnorSolver(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    __swig_destroy__ = _connor_solver.delete_ObserverConnorSolver
    def __init__(self): 
