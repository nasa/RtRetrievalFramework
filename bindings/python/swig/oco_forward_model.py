...
class OcoForwardModel(full_physics_swig.forward_model.ForwardModel,full_physics_swig.named_spectrum.ObservablePtrNamedSpectrum):
    ...
    def radiance(self, *args):
        ...
        """
        return _oco_forward_model.OcoForwardModel_radiance(self, *args)
    ...
    def apply_spectrum_corrections(self, *args):
        """
        ...
        """
        return _oco_forward_model.OcoForwardModel_apply_spectrum_corrections(self, *args)

    def notify_spectrum_update(self, *args):
        """
        void OcoForwardModel::notify_spectrum_update(const Spectrum &updated_spec, const std::string &spec_name, int
        Spec_index) const

        """
        return _oco_forward_model.OcoForwardModel_notify_spectrum_update(self, *args)
