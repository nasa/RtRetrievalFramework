...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _max_a_posteriori_output.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_max_a_posteriori_output')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_max_a_posteriori_output')
...
MaxAPosterioriOutput.register_output = new_instancemethod(_max_a_posteriori_output.MaxAPosterioriOutput_register_output, None, MaxAPosterioriOutput)
