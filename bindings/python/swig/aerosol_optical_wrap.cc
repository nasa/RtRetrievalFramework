...
SWIGINTERN PyObject *_wrap_new_AerosolOptical(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_AerosolOptical",0,5,argv))) SWIG_fail;
  --argc;
  if (argc == 4) {
...
SWIGINTERN PyObject *_wrap_AerosolOptical_clone(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"AerosolOptical_clone",0,3,argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
