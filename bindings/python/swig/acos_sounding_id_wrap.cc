...
SWIGINTERN void std_vector_Sl_boost_shared_ptr_Sl_FullPhysics_HdfSoundingId_Sg__Sg____setslice____SWIG_0(std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > > *self,std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > >::difference_type i,std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > >::difference_type j){
      swig::setslice(self, i, j, 1, std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId >,std::allocator< boost::shared_ptr< FullPhysics::HdfSoundingId > > >());
    }
SWIGINTERN void std_vector_Sl_boost_shared_ptr_Sl_FullPhysics_HdfSoundingId_Sg__Sg____setslice____SWIG_1(std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > > *self,std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > >::difference_type i,std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId > >::difference_type j,std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId >,std::allocator< boost::shared_ptr< FullPhysics::HdfSoundingId > > > const &v){
...
#include "acos_sounding_id_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_AcosSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AcosSoundingId_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_AcosSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_AcosSoundingId",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
...
SWIGINTERN PyObject *AcosSoundingId_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
SWIGINTERN PyObject *_wrap_vector_acos_sounding_id___setslice____SWIG_1(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  }
  {
    try {
      try {
        std_vector_Sl_boost_shared_ptr_Sl_FullPhysics_HdfSoundingId_Sg__Sg____setslice____SWIG_1(arg1,arg2,arg3,(std::vector< boost::shared_ptr< FullPhysics::HdfSoundingId >,std::allocator< boost::shared_ptr< FullPhysics::HdfSoundingId > > > const &)*arg4);
      }
      catch(std::out_of_range &_e) {
        SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
      }
