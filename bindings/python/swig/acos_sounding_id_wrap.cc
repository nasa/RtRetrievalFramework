...
#define SWIGTYPE_p_std__vectorT_boost__shared_ptrT_FullPhysics__HdfSoundingId_t_std__allocatorT_boost__shared_ptrT_FullPhysics__HdfSoundingId_t_t_t swig_types[45]
