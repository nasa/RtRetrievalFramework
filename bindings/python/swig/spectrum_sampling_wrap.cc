...
#include "spectrum_sampling_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_SpectrumSampling(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SpectrumSampling_spectral_domain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SpectrumSampling_spectral_domain",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
  ...
  arg2 = static_cast< int >(val2);
  {
    ...
    res3 = SWIG_ConvertPtrAndOwn(swig_obj[2], (void**)(&ptr), SWIGTYPE_p_FullPhysics__SpectralDomain,  0 , &newmem);
    if (SWIG_IsOK(res3)) {
      arg3 = ptr;
    } else {
      res3 = SWIG_ConvertPtrAndOwn(swig_obj[2], &argp3, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralDomain_t,  0 , &newmem);
      if (!SWIG_IsOK(res3)) {
...
SWIGINTERN PyObject *_wrap_SpectrumSampling_spectral_domain_interpolated(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SpectrumSampling_spectral_domain_interpolated",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SpectrumSampling_need_interpolation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SpectrumSampling_need_interpolation",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectrumSampling_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_SpectrumSampling", (PyCFunction)_wrap_delete_SpectrumSampling, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::SpectrumSampling::~SpectrumSampling()\n"
		"\n"
		""},
	 { (char *)"SpectrumSampling___str__", (PyCFunction)_wrap_SpectrumSampling___str__, METH_O, NULL},
	 { (char *)"SpectrumSampling__v_number_spectrometer", (PyCFunction)_wrap_SpectrumSampling__v_number_spectrometer, METH_O, (char *)"\n"
		"\n"
