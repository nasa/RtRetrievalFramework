...
#include "solar_doppler_shift_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_SolarDopplerShift(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarDopplerShift_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SolarDopplerShift_doppler_stretch(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SolarDopplerShift_doppler_stretch",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarDopplerShift_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_SolarDopplerShift", (PyCFunction)_wrap_delete_SolarDopplerShift, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::SolarDopplerShift::~SolarDopplerShift()\n"
		"\n"
		""},
	 { (char *)"SolarDopplerShift___str__", (PyCFunction)_wrap_SolarDopplerShift___str__, METH_O, NULL},
	 { (char *)"SolarDopplerShift__v_solar_distance", (PyCFunction)_wrap_SolarDopplerShift__v_solar_distance, METH_O, (char *)"\n"
		"\n"
