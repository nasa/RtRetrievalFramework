...
#include "hdf_file_generating_wrap.h"
...
SWIGINTERN PyObject *_wrap_HdfFileGenerating_close(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HdfFileGenerating_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *HdfFileGenerating_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

static PyMethodDef SwigMethods[] = {
	 { (char *)"SWIG_PyInstanceMethod_New", (PyCFunction)SWIG_PyInstanceMethod_New, METH_O, NULL},
	 { (char *)"new_HdfFileGenerating", (PyCFunction)_wrap_new_HdfFileGenerating, METH_O, (char *)"\n"
		"\n"
		...
		"class. \n"
		""},
	 { (char *)"HdfFileGenerating_close", (PyCFunction)_wrap_HdfFileGenerating_close, METH_O, (char *)"\n"
		"\n"
		"void HdfFileGenerating::close()\n"
		"Close a file, changing the name to the final name.\n"
		"\n"
		"This is automatically called by the destructor, so you don't need to\n"
		"call this directly. \n"
		""},
	 { (char *)"HdfFileGenerating_abandon", (PyCFunction)_wrap_HdfFileGenerating_abandon, METH_O, (char *)"\n"
		"\n"
		"void HdfFileGenerating::abandon()\n"
		"Abandon a file and clean it up.\n"
		"\n"
		"This would normally be called if an error condition occurs and we\n"
		"can't finish creating the file. \n"
		""},
	 { (char *)"HdfFileGenerating_hdf_file", (PyCFunction)_wrap_HdfFileGenerating_hdf_file, METH_O, (char *)"\n"
		"\n"
		"HdfFile & HdfFileGenerating::hdf_file()\n"
		"\n"
		""},
	 { (char *)"HdfFileGenerating___str__", (PyCFunction)_wrap_HdfFileGenerating___str__, METH_O, NULL},
	 { (char *)"delete_HdfFileGenerating", (PyCFunction)_wrap_delete_HdfFileGenerating, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"HdfFileGenerating_swiginit", HdfFileGenerating_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
