...
#include "solver_iteration_log_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_SolverIterationLog(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__StateVector_t,  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SolverIterationLog___str__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolverIterationLog_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *SolverIterationLog_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

static PyMethodDef SwigMethods[] = {
	 { (char *)"SWIG_PyInstanceMethod_New", (PyCFunction)SWIG_PyInstanceMethod_New, METH_O, NULL},
	 { (char *)"new_SolverIterationLog", (PyCFunction)_wrap_new_SolverIterationLog, METH_O, (char *)"\n"
		"\n"
		"FullPhysics::SolverIterationLog::SolverIterationLog(const boost::shared_ptr< StateVector > &Sv)\n"
		"\n"
		""},
	 { (char *)"SolverIterationLog___str__", (PyCFunction)_wrap_SolverIterationLog___str__, METH_O, NULL},
	 { (char *)"delete_SolverIterationLog", (PyCFunction)_wrap_delete_SolverIterationLog, METH_O, NULL},
	 { (char *)"SolverIterationLog_swigregister", SolverIterationLog_swigregister, METH_VARARGS, NULL},
	 { (char *)"SolverIterationLog_swiginit", SolverIterationLog_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
