...
SWIGINTERN PyObject *_wrap_delete_LogImp(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LogImp_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_LogImp_write(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"LogImp_write",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LogImp_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_LogImp_flush(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"LogImp_flush",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LogImp_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_Logger_set_implementation(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LogImp_t,  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_delete_Logger(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_FullPhysics__Logger, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_LogImp", (PyCFunction)_wrap_delete_LogImp, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"Logger_set_implementation", (PyCFunction)_wrap_Logger_set_implementation, METH_O, (char *)"\n"
		"\n"
		...
		""},
	 { (char *)"delete_Logger", (PyCFunction)_wrap_delete_Logger, METH_O, NULL},
