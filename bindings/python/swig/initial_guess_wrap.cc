...
SWIGINTERN PyObject *_wrap_delete_InitialGuess(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__InitialGuess_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_InitialGuess", (PyCFunction)_wrap_delete_InitialGuess, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::InitialGuess::~InitialGuess()\n"
		"\n"
		""},
	 { (char *)"InitialGuess___str__", (PyCFunction)_wrap_InitialGuess___str__, METH_O, NULL},
	 { (char *)"InitialGuess__v_initial_guess", (PyCFunction)_wrap_InitialGuess__v_initial_guess, METH_O, (char *)"\n"
		"\n"
		"virtual blitz::Array<double, 1> FullPhysics::InitialGuess::initial_guess() const =0\n"
		"Return the initial state vector to use. \n"
		""},
	 { (char *)"InitialGuess__v_apriori", (PyCFunction)_wrap_InitialGuess__v_apriori, METH_O, (char *)"\n"
		"\n"
		"virtual blitz::Array<double, 1> FullPhysics::InitialGuess::apriori() const =0\n"
		"Return the apriori state vector to use. \n"
		""},
	 { (char *)"InitialGuess__v_apriori_covariance", (PyCFunction)_wrap_InitialGuess__v_apriori_covariance, METH_O, (char *)"\n"
		"\n"
