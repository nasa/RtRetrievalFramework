...
#include "hdf_sounding_id_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_HdfSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__HdfSoundingId_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_HdfSoundingId", (PyCFunction)_wrap_delete_HdfSoundingId, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::HdfSoundingId::~HdfSoundingId()\n"
		"\n"
		""},
	 { (char *)"HdfSoundingId__v_frame_number", (PyCFunction)_wrap_HdfSoundingId__v_frame_number, METH_O, (char *)"\n"
		"\n"
		"virtual int FullPhysics::HdfSoundingId::frame_number() const\n"
		"\n"
		""},
	 { (char *)"HdfSoundingId__v_sounding_number", (PyCFunction)_wrap_HdfSoundingId__v_sounding_number, METH_O, (char *)"\n"
		"\n"
		"virtual int FullPhysics::HdfSoundingId::sounding_number() const\n"
		"\n"
		""},
	 { (char *)"HdfSoundingId__v_sounding_id", (PyCFunction)_wrap_HdfSoundingId__v_sounding_id, METH_O, (char *)"\n"
		"\n"
		"virtual int64_t FullPhysics::HdfSoundingId::sounding_id() const\n"
		"\n"
		""},
	 { (char *)"HdfSoundingId___str__", (PyCFunction)_wrap_HdfSoundingId___str__, METH_O, NULL},
