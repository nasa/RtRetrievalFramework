...
#include "stokes_coefficient_constant_wrap.h"
...
SWIGINTERN PyObject *_wrap_StokesCoefficientConstant_set_stokes_coefficient(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"StokesCoefficientConstant_set_stokes_coefficient",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__StokesCoefficientConstant_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"StokesCoefficientConstant_set_stokes_coefficient", _wrap_StokesCoefficientConstant_set_stokes_coefficient, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"delete_StokesCoefficientConstant", (PyCFunction)_wrap_delete_StokesCoefficientConstant, METH_O, (char *)"\n"
		"\n"
