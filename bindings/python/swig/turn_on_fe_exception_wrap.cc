...
/*-----------------------------------------------
              @(target):= _turn_on_fe_exception.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__turn_on_fe_exception

#else
#  define SWIG_init    init_turn_on_fe_exception

#endif
#define SWIG_name    "_turn_on_fe_exception"
...
#include "turn_on_fe_exception_wrap.h"

#ifdef __cplusplus
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_turn_on_fe_exception(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args,"turn_on_fe_exception",0,0,0)) SWIG_fail;
  {
    try {
      FullPhysics::turn_on_fe_exception();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"turn_on_fe_exception", (PyCFunction)_wrap_turn_on_fe_exception, METH_NOARGS, (char *)"\n"
		"\n"
