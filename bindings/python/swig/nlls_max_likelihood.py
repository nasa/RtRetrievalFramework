...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _nlls_max_likelihood.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_nlls_max_likelihood')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_nlls_max_likelihood')
...
class NLLSMaxLikelihood(full_physics_swig.nlls_problem.NLLSProblem, full_physics_swig.nlls_problem_state.NLLSProblemState):
    ...
    def __init__(self, ml, together=False):
        ...
        Constructor. 
        """
        _nlls_max_likelihood.NLLSMaxLikelihood_swiginit(self, _nlls_max_likelihood.new_NLLSMaxLikelihood(ml, together))
...
NLLSMaxLikelihood._v_residual = new_instancemethod(_nlls_max_likelihood.NLLSMaxLikelihood__v_residual, None, NLLSMaxLikelihood)
NLLSMaxLikelihood._v_jacobian = new_instancemethod(_nlls_max_likelihood.NLLSMaxLikelihood__v_jacobian, None, NLLSMaxLikelihood)
NLLSMaxLikelihood._v_parameters = new_instancemethod(_nlls_max_likelihood.NLLSMaxLikelihood__v_parameters, None, NLLSMaxLikelihood)
NLLSMaxLikelihood._v_max_likelihood = new_instancemethod(_nlls_max_likelihood.NLLSMaxLikelihood__v_max_likelihood, None, NLLSMaxLikelihood)
