...
#include "twostream_driver_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_TwostreamBrdfDriver(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamBrdfDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TwostreamBrdfDriver_setup_geometry(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamBrdfDriver_setup_geometry",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamBrdfDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TwostreamBrdfDriver_do_kparams_derivs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamBrdfDriver_do_kparams_derivs",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamBrdfDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *TwostreamBrdfDriver_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject *_wrap_new_TwostreamRtDriver__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  int arg1 ;
  int arg2 ;
  bool arg3 ;
...
SWIGINTERN PyObject *_wrap_TwostreamRtDriver_setup_height_grid(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamRtDriver_setup_height_grid",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
...
SWIGINTERN PyObject *_wrap_TwostreamRtDriver_setup_geometry(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamRtDriver_setup_geometry",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamRtDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TwostreamRtDriver_setup_optical_inputs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamRtDriver_setup_optical_inputs",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamRtDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TwostreamRtDriver_setup_linear_inputs(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamRtDriver_setup_linear_inputs",5,5,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamRtDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_TwostreamRtDriver_copy_jacobians(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"TwostreamRtDriver_copy_jacobians",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__TwostreamRtDriver_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *TwostreamRtDriver_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

static PyMethodDef SwigMethods[] = {
	 { (char *)"SWIG_PyInstanceMethod_New", (PyCFunction)SWIG_PyInstanceMethod_New, METH_O, NULL},
	 { (char *)"new_TwostreamBrdfDriver", (PyCFunction)_wrap_new_TwostreamBrdfDriver, METH_O, (char *)"\n"
		"\n"
		"TwostreamBrdfDriver::TwostreamBrdfDriver(int surface_type)\n"
		"Initialize Twostream BRDF interface. \n"
		""},
	 { (char *)"delete_TwostreamBrdfDriver", (PyCFunction)_wrap_delete_TwostreamBrdfDriver, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"TwostreamBrdfDriver_setup_geometry", _wrap_TwostreamBrdfDriver_setup_geometry, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_n_brdf_kernels", (PyCFunction)_wrap_TwostreamBrdfDriver__v_n_brdf_kernels, METH_O, (char *)"\n"
		"\n"
		"int TwostreamBrdfDriver::n_brdf_kernels() const\n"
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_n_kernel_factor_wfs", (PyCFunction)_wrap_TwostreamBrdfDriver__v_n_kernel_factor_wfs, METH_O, (char *)"\n"
		"\n"
		"int TwostreamBrdfDriver::n_kernel_factor_wfs() const\n"
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_n_kernel_params_wfs", (PyCFunction)_wrap_TwostreamBrdfDriver__v_n_kernel_params_wfs, METH_O, (char *)"\n"
		"\n"
		"int TwostreamBrdfDriver::n_kernel_params_wfs() const\n"
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_n_surface_wfs", (PyCFunction)_wrap_TwostreamBrdfDriver__v_n_surface_wfs, METH_O, (char *)"\n"
		"\n"
		"int TwostreamBrdfDriver::n_surface_wfs() const\n"
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_do_shadow_effect", (PyCFunction)_wrap_TwostreamBrdfDriver__v_do_shadow_effect, METH_O, (char *)"\n"
		"\n"
		"bool TwostreamBrdfDriver::do_shadow_effect() const\n"
		"\n"
		""},
	 { (char *)"TwostreamBrdfDriver__v_brdf_interface", (PyCFunction)_wrap_TwostreamBrdfDriver__v_brdf_interface, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"TwostreamRtDriver_setup_optical_inputs", _wrap_TwostreamRtDriver_setup_optical_inputs, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"TwostreamRtDriver_clear_linear_inputs", (PyCFunction)_wrap_TwostreamRtDriver_clear_linear_inputs, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"TwostreamRtDriver_setup_linear_inputs", _wrap_TwostreamRtDriver_setup_linear_inputs, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"TwostreamRtDriver_calculate_rt", (PyCFunction)_wrap_TwostreamRtDriver_calculate_rt, METH_O, (char *)"\n"
		"\n"
		"void TwostreamRtDriver::calculate_rt() const\n"
		"\n"
		""},
	 { (char *)"TwostreamRtDriver_get_intensity", (PyCFunction)_wrap_TwostreamRtDriver_get_intensity, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"TwostreamRtDriver_copy_jacobians", _wrap_TwostreamRtDriver_copy_jacobians, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"TwostreamRtDriver__v_twostream_brdf_driver", (PyCFunction)_wrap_TwostreamRtDriver__v_twostream_brdf_driver, METH_O, (char *)"\n"
		"\n"
		"boost::shared_ptr<TwostreamBrdfDriver> FullPhysics::TwostreamRtDriver::twostream_brdf_driver() const\n"
		"\n"
		""},
	 { (char *)"TwostreamRtDriver__v_brdf_interface", (PyCFunction)_wrap_TwostreamRtDriver__v_brdf_interface, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"TwostreamRtDriver_swiginit", TwostreamRtDriver_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
