...
#include "solar_continuum_spectrum_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_SolarContinuumSpectrum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarContinuumSpectrum_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_SolarContinuumSpectrum_solar_continuum_spectrum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"SolarContinuumSpectrum_solar_continuum_spectrum",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SolarContinuumSpectrum_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_SolarContinuumSpectrum", (PyCFunction)_wrap_delete_SolarContinuumSpectrum, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::SolarContinuumSpectrum::~SolarContinuumSpectrum()\n"
		"\n"
		""},
	 { (char *)"SolarContinuumSpectrum___str__", (PyCFunction)_wrap_SolarContinuumSpectrum___str__, METH_O, NULL},
