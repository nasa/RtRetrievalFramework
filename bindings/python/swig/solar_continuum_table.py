...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _solar_continuum_table.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_solar_continuum_table')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_solar_continuum_table')
...
class SolarContinuumTable(full_physics_swig.solar_continuum_spectrum.SolarContinuumSpectrum):
    ...
    def __init__(self, F, Hdf_group, Convert_from_photon=True):
        ...
        """
        _solar_continuum_table.SolarContinuumTable_swiginit(self, _solar_continuum_table.new_SolarContinuumTable(F, Hdf_group, Convert_from_photon))
