...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _gosat_noise_model.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_gosat_noise_model')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_gosat_noise_model')
...
class GosatNoiseModel(full_physics_swig.noise_model.NoiseModel):
    ...
    def __init__(self, *args):
        ...
        file. 
        """
        _gosat_noise_model.GosatNoiseModel_swiginit(self, _gosat_noise_model.new_GosatNoiseModel(*args))
