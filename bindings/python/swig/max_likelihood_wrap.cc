...
SWIGINTERN PyObject *_wrap_delete_MaxLikelihood(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__MaxLikelihood_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_MaxLikelihood", (PyCFunction)_wrap_delete_MaxLikelihood, METH_O, (char *)"\n"
		"\n"
