...
#include "state_vector_output_wrap.h"
...
SWIGINTERN PyObject *_wrap_StateVectorOutput_register_output(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"StateVectorOutput_register_output",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__StateVectorOutput_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"StateVectorOutput_register_output", _wrap_StateVectorOutput_register_output, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"delete_StateVectorOutput", (PyCFunction)_wrap_delete_StateVectorOutput, METH_O, (char *)"\n"
		"\n"
