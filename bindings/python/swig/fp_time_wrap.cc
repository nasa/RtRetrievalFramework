...
SWIGINTERN PyObject *_wrap_Time__v_unix_time(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__Time_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Time_time_unix", (PyCFunction)_wrap_Time_time_unix, METH_O, (char *)"\n"
		...
		""},
	 { (char *)"Time__v_unix_time", (PyCFunction)_wrap_Time__v_unix_time, METH_O, (char *)"\n"
		"\n"
		"double FullPhysics::Time::unix_time() const\n"
		"Give time in unix time, as a double (epoch 1970-01-01) \n"
		""},
	 { (char *)"Time__v_pgs_time", (PyCFunction)_wrap_Time__v_pgs_time, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"new_Time", (PyCFunction)_wrap_new_Time, METH_NOARGS, (char *)"\n"
		"\n"
