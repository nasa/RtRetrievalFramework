...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _solar_doppler_shift_polynomial.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_solar_doppler_shift_polynomial')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_solar_doppler_shift_polynomial')
...
class SolarDopplerShiftPolynomial(full_physics_swig.solar_doppler_shift.SolarDopplerShift):
    ...
    def __init__(self, *args):
        ...
        """
        _solar_doppler_shift_polynomial.SolarDopplerShiftPolynomial_swiginit(self, _solar_doppler_shift_polynomial.new_SolarDopplerShiftPolynomial(*args))
...
SolarDopplerShiftPolynomial._v_doppler_shift = new_instancemethod(_solar_doppler_shift_polynomial.SolarDopplerShiftPolynomial__v_doppler_shift, None, SolarDopplerShiftPolynomial)
SolarDopplerShiftPolynomial._v_solar_velocity = new_instancemethod(_solar_doppler_shift_polynomial.SolarDopplerShiftPolynomial__v_solar_velocity, None, SolarDopplerShiftPolynomial)
SolarDopplerShiftPolynomial._v_total_velocity = new_instancemethod(_solar_doppler_shift_polynomial.SolarDopplerShiftPolynomial__v_total_velocity, None, SolarDopplerShiftPolynomial)
