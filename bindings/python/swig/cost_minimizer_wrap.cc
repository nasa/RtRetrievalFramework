...
SWIGINTERN PyObject *_wrap_delete_CostMinimizer(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__CostMinimizer_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_CostMinimizer", (PyCFunction)_wrap_delete_CostMinimizer, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::CostMinimizer::~CostMinimizer()\n"
		"\n"
		""},
	 { (char *)"CostMinimizer__v_cost_min_problem", (PyCFunction)_wrap_CostMinimizer__v_cost_min_problem, METH_O, (char *)"\n"
		"\n"
