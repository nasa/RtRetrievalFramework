...
#include "reference_vmr_apriori_wrap.h"
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_model_tropopause_altitude(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_age_of_air(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_age_of_air",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_resample_to_model_grid(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_resample_to_model_grid",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_apply_latitude_gradient(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_apply_latitude_gradient",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_apply_secular_trend(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_apply_secular_trend",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_apply_seasonal_cycle(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_apply_seasonal_cycle",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_ReferenceVmrApriori_apriori_vmr(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"ReferenceVmrApriori_apriori_vmr",3,3,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__ReferenceVmrApriori_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *ReferenceVmrApriori_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_ReferenceVmrApriori", _wrap_new_ReferenceVmrApriori, METH_VARARGS, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"ReferenceVmrApriori_model_tropopause_altitude", (PyCFunction)_wrap_ReferenceVmrApriori_model_tropopause_altitude, METH_O, (char *)"\n"
		"\n"
		...
		""},
	 { (char *)"ReferenceVmrApriori_effective_altitude", (PyCFunction)_wrap_ReferenceVmrApriori_effective_altitude, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"ReferenceVmrApriori_apriori_vmr", _wrap_ReferenceVmrApriori_apriori_vmr, METH_VARARGS, (char *)"\n"
		...
		"the class. \n"
		""},
	 { (char *)"ReferenceVmrApriori___str__", (PyCFunction)_wrap_ReferenceVmrApriori___str__, METH_O, NULL},
	 { (char *)"delete_ReferenceVmrApriori", (PyCFunction)_wrap_delete_ReferenceVmrApriori, METH_O, NULL},
	 { (char *)"ReferenceVmrApriori_swigregister", ReferenceVmrApriori_swigregister, METH_VARARGS, NULL},
	 { (char *)"ReferenceVmrApriori_swiginit", ReferenceVmrApriori_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
