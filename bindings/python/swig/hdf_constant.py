...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_hdf_constant')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_hdf_constant')
...
class HdfConstant(full_physics_swig.constant.Constant):
    ...
    def __init__(self, Hdf_file):
        ...
        """
        _hdf_constant.HdfConstant_swiginit(self, _hdf_constant.new_HdfConstant(Hdf_file))
