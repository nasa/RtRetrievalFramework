...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _solar_absorption_spectrum.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_solar_absorption_spectrum')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_solar_absorption_spectrum')
...
SolarAbsorptionSpectrum.__str__ = new_instancemethod(_solar_absorption_spectrum.SolarAbsorptionSpectrum___str__, None, SolarAbsorptionSpectrum)
SolarAbsorptionSpectrum.solar_absorption_spectrum = new_instancemethod(_solar_absorption_spectrum.SolarAbsorptionSpectrum_solar_absorption_spectrum, None, SolarAbsorptionSpectrum)
