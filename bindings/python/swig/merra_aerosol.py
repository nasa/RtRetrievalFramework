...
class MerraAerosol(full_physics_swig.generic_object.GenericObject):
    ...
    def __init__(self, Merra_climatology, Aerosol_property, Latitude, Longitude, Press, Aerosol_cov, Max_aod=0.2, Exp_aod=0.8, Min_types=2, Max_types=4, Max_residual=0.005, Reference_wn=1):
        """
        ...
        ATB. 
        """
        _merra_aerosol.MerraAerosol_swiginit(self, _merra_aerosol.new_MerraAerosol(Merra_climatology, Aerosol_property, Latitude, Longitude, Press, Aerosol_cov, Max_aod, Exp_aod, Min_types, Max_types, Max_residual, Reference_wn))
