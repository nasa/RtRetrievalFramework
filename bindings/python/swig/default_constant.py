...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _default_constant.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_default_constant')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_default_constant')
...
class DefaultConstant(full_physics_swig.constant.Constant):
    ...
    def __init__(self):
        ...
        """
        _default_constant.DefaultConstant_swiginit(self, _default_constant.new_DefaultConstant())
