...
#include "lua_state_wrap.h"

#ifdef __cplusplus
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_new_LuaState__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
...
SWIGINTERN PyObject *_wrap_new_LuaState__SWIG_1(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  FullPhysics::LuaState *result = 0 ;
...
SWIGINTERN PyObject *_wrap_new_LuaState(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_LuaState",0,1,argv))) SWIG_fail;
  --argc;
  if (argc == 0) {
    return _wrap_new_LuaState__SWIG_1(self, argc, argv);
  }
  if (argc == 1) {
    return _wrap_new_LuaState__SWIG_0(self, argc, argv);
  }
...
SWIGINTERN PyObject *_wrap_LuaState___str__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LuaState_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_LuaState_do_file(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"LuaState_do_file",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LuaState_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_LuaState_run(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"LuaState_run",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__LuaState_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *LuaState_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_LuaState", _wrap_new_LuaState, METH_VARARGS, (char *)"\n"
		...
		"from. \n"
		""},
	 { (char *)"LuaState___str__", (PyCFunction)_wrap_LuaState___str__, METH_O, NULL},
	 { (char *)"LuaState_load_file", (PyCFunction)_wrap_LuaState_load_file, METH_O, (char *)"\n"
		"\n"
	 ...
	 { (char *)"LuaState_run", _wrap_LuaState_run, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"LuaState__v_globals", (PyCFunction)_wrap_LuaState__v_globals, METH_O, (char *)"\n"
		"\n"
		"LuabindObject LuaState::globals()\n"
		"Globals table. \n"
		""},
	 { (char *)"LuaState__v_registry", (PyCFunction)_wrap_LuaState__v_registry, METH_O, (char *)"\n"
		"\n"
		"LuabindObject LuaState::registry()\n"
		"Registery table. \n"
		""},
	 { (char *)"delete_LuaState", (PyCFunction)_wrap_delete_LuaState, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::LuaState::~LuaState()\n"
		"\n"
		""},
	 { (char *)"LuaState_swigregister", LuaState_swigregister, METH_VARARGS, NULL},
	 { (char *)"LuaState_swiginit", LuaState_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
