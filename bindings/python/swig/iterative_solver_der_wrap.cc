...
#define SWIGTYPE_p_std__vectorT_blitz__ArrayT_double_1_t_std__allocatorT_blitz__ArrayT_double_1_t_t_t swig_types[35]
...
#include "iterative_solver_der_wrap.h"
...
SWIGINTERN PyObject *_wrap_delete_IterativeSolverDer(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__IterativeSolverDer_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_IterativeSolverDer_record_gradient_at_accepted_point(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"IterativeSolverDer_record_gradient_at_accepted_point",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__IterativeSolverDer_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_IterativeSolverDer", (PyCFunction)_wrap_delete_IterativeSolverDer, METH_O, (char *)"\n"
		"virtual FullPhysics::IterativeSolverDer::~IterativeSolverDer()\n"
		"\n"
		""},
	 { (char *)"IterativeSolverDer__v_gradient_at_accepted_points", (PyCFunction)_wrap_IterativeSolverDer__v_gradient_at_accepted_points, METH_O, (char *)"\n"
