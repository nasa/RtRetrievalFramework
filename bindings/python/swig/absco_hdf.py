...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _absco_hdf.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_absco_hdf')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_absco_hdf')
...
AbscoHdf.load_file = new_instancemethod(_absco_hdf.AbscoHdf_load_file, None, AbscoHdf)
AbscoHdf._v_file_name = new_instancemethod(_absco_hdf.AbscoHdf__v_file_name, None, AbscoHdf)
