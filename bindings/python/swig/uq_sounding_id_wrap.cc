...
SWIGINTERN PyObject *_wrap_new_UqSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_UqSoundingId",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    // Added mms
...
SWIGINTERN PyObject *_wrap_delete_UqSoundingId(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__UqSoundingId_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *UqSoundingId_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_UqSoundingId", _wrap_new_UqSoundingId, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"delete_UqSoundingId", (PyCFunction)_wrap_delete_UqSoundingId, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::UqSoundingId::~UqSoundingId()\n"
		"\n"
		""},
	 { (char *)"UqSoundingId_swigregister", UqSoundingId_swigregister, METH_VARARGS, NULL},
	 { (char *)"UqSoundingId_swiginit", UqSoundingId_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
