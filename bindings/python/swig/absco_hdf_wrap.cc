...
#include "absco_hdf_wrap.h"

#ifdef __cplusplus
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__AbscoHdf_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file__SWIG_1(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  FullPhysics::AbscoHdf *arg1 = (FullPhysics::AbscoHdf *) 0 ;
  std::string *arg2 = 0 ;
  double arg3 ;
...
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file__SWIG_2(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  FullPhysics::AbscoHdf *arg1 = (FullPhysics::AbscoHdf *) 0 ;
  std::string *arg2 = 0 ;
  double arg3 ;
...
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file__SWIG_3(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  FullPhysics::AbscoHdf *arg1 = (FullPhysics::AbscoHdf *) 0 ;
  std::string *arg2 = 0 ;
  ...
  }
  {
    ...
    res3 = SWIG_ConvertPtrAndOwn(swig_obj[2], (void**)(&ptr), SWIGTYPE_p_FullPhysics__SpectralBound,  0 , &newmem);
    if (SWIG_IsOK(res3)) {
      arg3 = ptr;
    } else {
      res3 = SWIG_ConvertPtrAndOwn(swig_obj[2], &argp3, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__SpectralBound_t,  0 , &newmem);
      if (!SWIG_IsOK(res3)) {
...
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file__SWIG_4(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  FullPhysics::AbscoHdf *arg1 = (FullPhysics::AbscoHdf *) 0 ;
  std::string *arg2 = 0 ;
  FullPhysics::SpectralBound *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_AbscoHdf_load_file(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"AbscoHdf_load_file",0,5,argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    return _wrap_AbscoHdf_load_file__SWIG_0(self, argc, argv);
  }
  if (argc == 3) {
    return _wrap_AbscoHdf_load_file__SWIG_2(self, argc, argv);
  }
  if (argc == 4) {
    int _v = 0;
    {
    ...
    if (!_v) goto check_3;
    return _wrap_AbscoHdf_load_file__SWIG_4(self, argc, argv);
  }
check_3:
  
  if (argc == 4) {
    return _wrap_AbscoHdf_load_file__SWIG_1(self, argc, argv);
  }
  if (argc == 5) {
    return _wrap_AbscoHdf_load_file__SWIG_3(self, argc, argv);
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"AbscoHdf_load_file", _wrap_AbscoHdf_load_file, METH_VARARGS, (char *)"\n"
		"\n"
		"void AbscoHdf::load_file(const std::string &Fname, const SpectralBound &Spectral_bound, const\n"
		"std::vector< double > &Table_scale, int Cache_nline=5000)\n"
		"Read the given Absco file.\n"
		"\n"
		"Note that you don't normally call this directly, but rather use the\n"
		"constructor. However there are certain uses where changing the absco\n"
		"table can be useful, such as the python code l2_fp_fm_errors.py. \n"
		""},
	 { (char *)"AbscoHdf__v_file_name", (PyCFunction)_wrap_AbscoHdf__v_file_name, METH_O, (char *)"\n"
		"\n"
		"virtual std::string FullPhysics::AbscoHdf::file_name() const\n"
		"\n"
		""},
	 { (char *)"delete_AbscoHdf", (PyCFunction)_wrap_delete_AbscoHdf, METH_O, (char *)"\n"
		"\n"
