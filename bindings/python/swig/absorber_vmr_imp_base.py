...
class AbsorberVmrImpBase(SubStateVectorArrayAbsorberVmr):
    ...
    def print_desc(self, *args):
        ...
        desc. 
        """
        return _absorber_vmr_imp_base.AbsorberVmrImpBase_print_desc(self, *args)
    ...
    def __init__(self, *args): 
        if self.__class__ == AbsorberVmrImpBase:
            ...
            _self = self
        _absorber_vmr_imp_base.AbsorberVmrImpBase_swiginit(self,_absorber_vmr_imp_base.new_AbsorberVmrImpBase(_self, *args))
    def __disown__(self):
        self.this.disown()
