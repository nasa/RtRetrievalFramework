...
class Level1bCache(full_physics_swig.level_1b.Level1b):
    ...
    def __init__(self, *args): 
        ...
        Constructor. 
        """
        _level_1b_cache.Level1bCache_swiginit(self,_level_1b_cache.new_Level1bCache(*args))
    def set_latitude(self, *args):
        """
        void FullPhysics::Level1bCache::set_latitude(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_latitude(self, *args)
    ...
    def set_longitude(self, *args):
        ...
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_longitude(self, *args)

    def set_sounding_zenith(self, *args):
        """
        void FullPhysics::Level1bCache::set_sounding_zenith(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_sounding_zenith(self, *args)

    def set_sounding_azimuth(self, *args):
        """
        void FullPhysics::Level1bCache::set_sounding_azimuth(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_sounding_azimuth(self, *args)

    def set_stokes_coefficient(self, *args):
        """
        void FullPhysics::Level1bCache::set_stokes_coefficient(int i, const blitz::Array< double, 1 > &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_stokes_coefficient(self, *args)

    def set_solar_zenith(self, *args):
        """
        void FullPhysics::Level1bCache::set_solar_zenith(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_solar_zenith(self, *args)

    def set_solar_azimuth(self, *args):
        """
        void FullPhysics::Level1bCache::set_solar_azimuth(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_solar_azimuth(self, *args)
    ...
    def set_altitude(self, *args):
        ...
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_altitude(self, *args)

    def set_relative_velocity(self, *args):
        """
        void FullPhysics::Level1bCache::set_relative_velocity(int i, const DoubleWithUnit &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_relative_velocity(self, *args)

    def set_spectral_coefficient(self, *args):
        """
        void FullPhysics::Level1bCache::set_spectral_coefficient(int i, const ArrayWithUnit< double, 1 > &V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_spectral_coefficient(self, *args)
    ...
    def set_time(self, *args):
        ...
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_time(self, *args)

    def radiance(self, *args):
        """
        virtual SpectralRange FullPhysics::Level1bCache::radiance(int i) const

        """
        return _level_1b_cache.Level1bCache_radiance(self, *args)
    ...
    def set_sounding_id(self, *args):
        """
        void FullPhysics::Level1bCache::set_sounding_id(int64_t V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_sounding_id(self, *args)

    def set_exposure_index(self, *args):
        """
        void FullPhysics::Level1bCache::set_exposure_index(int V)
        Change value. 
        """
        return _level_1b_cache.Level1bCache_set_exposure_index(self, *args)
