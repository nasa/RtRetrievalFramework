...
class Instrument(full_physics_swig.state_vector.StateVectorObserver,ObservableInstrument):
    ...
    def apply_instrument_model(self, *args):
        """
        ...
        """
        return _instrument.Instrument_apply_instrument_model(self, *args)
    ...
    def pixel_spectral_domain(self, *args):
        """
        ...
        """
        return _instrument.Instrument_pixel_spectral_domain(self, *args)

    def band_name(self, *args):
        """
        virtual std::string FullPhysics::Instrument::band_name(int Spec_index) const =0
        Band name for given Spec_index. 
        """
        return _instrument.Instrument_band_name(self, *args)
    ...
    def hdf_band_name(self, *args):
        ...
        name. 
        """
        return _instrument.Instrument_hdf_band_name(self, *args)
