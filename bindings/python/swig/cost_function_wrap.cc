...
SWIGINTERN PyObject *_wrap_delete_CostFunction(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__CostFunction_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_CostFunction_cost_function(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"CostFunction_cost_function",2,2,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_FullPhysics__CostFunction_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"delete_CostFunction", (PyCFunction)_wrap_delete_CostFunction, METH_O, (char *)"\n"
		"\n"
		"virtual FullPhysics::CostFunction::~CostFunction()\n"
		"\n"
		""},
	 { (char *)"CostFunction___str__", (PyCFunction)_wrap_CostFunction___str__, METH_O, NULL},
