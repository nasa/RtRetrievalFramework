...
class TemperatureImpBase(SubStateVectorArrayTemperature):
    ...
    def temperature(self, *args):
        ...
        """
        return _temperature_imp_base.TemperatureImpBase_temperature(self, *args)
    ...
    def print_desc(self, *args):
        ...
        desc. 
        """
        return _temperature_imp_base.TemperatureImpBase_print_desc(self, *args)
    ...
    def __init__(self, *args): 
        if self.__class__ == TemperatureImpBase:
            ...
            _self = self
        _temperature_imp_base.TemperatureImpBase_swiginit(self,_temperature_imp_base.new_TemperatureImpBase(_self, *args))
    def __disown__(self):
        self.this.disown()
