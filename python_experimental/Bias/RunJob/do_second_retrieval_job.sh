...
sid="${id_list[${sid_ind}]}"
if test -e ${sid}/retrieval_initial_${drawind}.shlv; then
    python ~/Level2/python_experimental/Bias/do_retrieval.py ${sid} ${sid}/cov_draw.shlv ${sid}/draw_${drawind}.shlv ${sid}/retrieval_second_${drawind}.shlv
fi
