...
if [ $group_size -gt 9 ]; then
    ...
    /l2_support_fake_path/utils/splice_product_files.py --single-file-type -o ${output_directory}/l2_aggregate.h5 -i $input_files_tmp -l ${log_directory}/l2_aggregate.log
    rm $input_files_tmp
fi
